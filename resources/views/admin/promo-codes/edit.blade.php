<x-app-layout>
    <div class="container py-4">
        <h1 class="mb-4">Chỉnh Sửa Mã Giảm Giá: {{ $promoCode->code }}</h1>
                        ...
                        <form action="{{ route('admin.promo-codes.update', $promoCode->id) }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('code') is-invalid @enderror" 
                                       ...
                                       value="{{ old('code', $promoCode->code) }}" required maxlength="20">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select @error('discount_type') is-invalid @enderror" 
                                            ...
                                            <option value="fixed" {{ old('discount_type', $promoCode->discount_type) === 'fixed' ? 'selected' : '' }}>Cố Định (đ)</option>
                                            <option value="percentage" {{ old('discount_type', $promoCode->discount_type) === 'percentage' ? 'selected' : '' }}>Phần Trăm (%)</option>
                                        </select>
                                        @error('discount_type')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control @error('discount_value') is-invalid @enderror" 
                                               ...
                                               placeholder="0" value="{{ old('discount_value', $promoCode->discount_value) }}" 
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control @error('max_usage') is-invalid @enderror" 
                                               ...
                                               value="{{ old('max_usage', $promoCode->max_usage) }}" min="1">
                                        <small class="text-muted">Để trống nếu không muốn giới hạn | <strong>Đã sử dụng: {{ $promoCode->used_count }} lần</strong></small>
                                        @error('max_usage')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="date" class="form-control @error('expires_at') is-invalid @enderror" 
                                               ...
                                               value="{{ old('expires_at', $promoCode->expires_at?->format('Y-m-d')) }}">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('description') is-invalid @enderror" 
                                       ...
                                       value="{{ old('description', $promoCode->description) }}" maxlength="255">
                                @error('description')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3 form-check">
                                <input type="checkbox" class="form-check-input" id="is_active" 
                                       name="is_active" value="1" {{ old('is_active', $promoCode->is_active) ? 'checked' : '' }}>
            ...
            <div class="col-md-4">
                <div class="card bg-light mb-3">
                    <div class="card-body">
                        ...
                        <p><strong>Tạo Lúc:</strong> {{ $promoCode->created_at->format('d/m/Y H:i') }}</p>
                        <p><strong>Cập Nhật Lúc:</strong> {{ $promoCode->updated_at->format('d/m/Y H:i') }}</p>
                        <p><strong>Đã Sử Dụng:</strong> {{ $promoCode->used_count }} lần</p>
                    </div>
                </div>
