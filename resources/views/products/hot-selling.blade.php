        ...
        <div class="container">
            ...
            <nav aria-label="breadcrumb" class="mb-3">
                <ol class="breadcrumb small mb-0" style="background: transparent;">
                    ...
                    <li class="breadcrumb-item active" aria-current="page" style="color: var(--bm-dark)">Sản phẩm bán chạy</li>
                </ol>
            </nav>
            ...
            <div class="d-flex align-items-center justify-content-between mb-4">
                <div>
                    <h1 class="h2 mb-2" style="color: var(--bm-dark); font-weight: 700;">🏆 Sản phẩm bán chạy nhất</h1>
                    <p style="color: #666; margin: 0;">Những sản phẩm yêu thích nhất của khách hàng</p>
                </div>
            </div>
        </div>
    </div>
                        ...
                        @foreach($breads as $bread)
                            <div class="col-md-6 col-lg-4 mb-3">
                                <div class="product-card" style="background: white; border-radius: 12px; overflow: hidden; border: 1px solid #eee; height: 100%; display: flex; flex-direction: column; position: relative;">
                                    {{-- Hot Badge --}}
                                    <div style="position: absolute; top: 15px; right: 15px; background: var(--bm-coral); color: white; padding: 5px 12px; border-radius: 20px; font-size: 0.8rem; font-weight: 700; z-index: 10;">
                                        Bán chạy
                                    </div>
