        ...
        <div class="container">
            ...
            <nav aria-label="breadcrumb" class="mb-3">
                <ol class="breadcrumb small mb-0" style="background: transparent;">
                    ...
                    <li class="breadcrumb-item active" aria-current="page" style="color: var(--bm-dark)">Bánh mặn</li>
                </ol>
            </nav>
            ...
            <div class="d-flex align-items-center justify-content-between mb-4">
                <div>
                    <h1 class="h2 mb-2" style="color: var(--bm-dark); font-weight: 700;">🥐 Bánh mặn hấp dẫn</h1>
                    <p style="color: #666; margin: 0;">Những chiếc bánh mặn đậm đà, hương vị ngon miệng phù hợp cho bữa sáng hoặc bữa xế</p>
                </div>
            </div>
        </div>
    </div>
                ...
                @if($breads->count() > 0)
                    <div class="row g-4" id="breads">
                        @foreach($breads as $bread)
                            <div class="col-md-6 col-lg-6 mb-3" onmouseover="this.querySelector('.product-overlay').style.opacity='1'" onmouseout="this.querySelector('.product-overlay').style.opacity='0'">
                ...
                @else
                    <div style="background: white; border-radius: 12px; padding: 60px 20px; text-align: center; border: 1px solid #eee;">
                        ...
                        <p style="color: #666; margin: 0;">
                            Hiện tại chưa có bánh mặn nào trong cửa hàng.
                        </p>
                    </div>
                @endif
            </div>
