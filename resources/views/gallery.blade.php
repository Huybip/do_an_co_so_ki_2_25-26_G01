        ...
        <div class="row g-4" id="galleryGrid">
            @forelse($breads as $bread)
                <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                    <div class="gallery-item position-relative overflow-hidden" style="background: white; border-radius: 12px; cursor: pointer; transition: all 0.3s; border: 1px solid #eee; box-shadow: 0 2px 8px rgba(0, 0, 0, 0.1);" 
